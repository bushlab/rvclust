#' Automated test for aggregation modules
#'
#' ---------------------------------------------------------------------- '#\cr
#' Use this function to test aggregation modules.
#' ---------------------------------------------------------------------- '#\cr
#'
#' @author R Michael Sivley \email{mike.sivley@@vanderbilt.edu}
#' @export
#' @param aggregation function
#' @return validity
test.aggregation <- function(AGGREGATION.FUN) {
	data('test.rv')
	...
	writeLines("Aggregation module is valid.")
}
